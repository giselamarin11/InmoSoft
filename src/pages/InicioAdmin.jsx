                                ...
                                <div className="contenido-tarjeta">
                                    ...
                                    <div className="acciones-tarjeta">
                                        ...
                                        <div className="menu-admin">
                                            <button className="btn-menu" onClick={() => toggleMenu(propiedad.id)}>
                                                <MoreVertical />
                                            </button>
                                            {menuAbierto === propiedad.id && (
                                                <div className="menu-opciones">
                                                    <button onClick={() => editarPropiedad(propiedad.id)}>✏️ Editar</button>
                                                    <button onClick={() => eliminarPropiedad(propiedad.id)}>🗑️ Eliminar</button>
                                                    <button onClick={agregarPropiedad}>➕ Agregar nueva</button>
                                                </div>
                                            )}
                                        </div>
